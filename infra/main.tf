...
module "orchestration" {
  ...
  load_komiser_results_arn    = module.lambdas.load_komiser_results_arn
  ...
  komiser_task_definition_arn = module.prowler_fargate.komiser_task_definition_arn
  ...
  komiser_container_name      = module.prowler_fargate.komiser_container_name
